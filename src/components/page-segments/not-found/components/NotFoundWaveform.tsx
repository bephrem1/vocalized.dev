...
interface NotFoundWaveformProps {
  fadeInDelayMs?: number;
}

const NotFoundWaveform: FunctionComponent<NotFoundWaveformProps> = ({ fadeInDelayMs = 2000 }) => {
  ...
  const opacity = useOpacity({ start: 0, end: 1, durationMs: 1500, fadeInDelayMs });

  return <div ref={mountRef} style={{ opacity }} />;
};

export default NotFoundWaveform;
